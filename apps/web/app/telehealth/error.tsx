...
export default function TelehealthErrorBoundary({
  ...
  useEffect(() => {
    console.error("Caught Telehealth Route Error:", error);
  }, [error]);
  ...
  return (
    <AppLayout
      ...
      breadcrumbs={[{ label: "Dashboard" }, { label: "Telehealth" }, { label: "System Error" }]}
    >
      <div className="flex items-center justify-center min-h-[450px] p-6 text-center">
        <div className="max-w-md bg-white rounded-2xl border border-red-100 p-8 shadow-sm flex flex-col items-center">
          ...
          <h2 className="font-display text-xl font-bold text-gray-900 mb-2">
            Failed to load telehealth room
          </h2>
          
          {/* Subtle Context Message */}
          <p className="text-sm text-gray-500 leading-relaxed mb-6">
            We encountered a temporary network or rendering issue within the virtual consultation interface. Your connection room token and scheduling slots remain valid. Please try resetting the workspace below.
          </p>
