...
export default function SettingsErrorBoundary({
  ...
  useEffect(() => {
    console.error("Caught Settings Route Error:", error);
  }, [error]);
  ...
  return (
    <AppLayout
      ...
      breadcrumbs={[{ label: "Dashboard" }, { label: "Settings" }, { label: "System Error" }]}
    >
      <div className="flex items-center justify-center min-h-[450px] p-6 text-center">
        <div className="max-w-md bg-white rounded-2xl border border-red-100 p-8 shadow-sm flex flex-col items-center">
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-6">
            We encountered a temporary issue while loading your workspace preferences and configurations. Rest assured, your security settings and profile data remain completely unaltered. Please try refreshing the panel below.
          </p>
