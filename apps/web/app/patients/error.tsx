...
export default function PatientsErrorBoundary({
  error,
  reset,
  title = "Patients Directory Error",
  activeItem = "patients",
}: ErrorProps) {
  
  useEffect(() => {
    console.error("Caught Patients Route Error:", error);
  }, [error]);
  ...
  return (
    <AppLayout
      ...
      breadcrumbs={[{ label: "Dashboard" }, { label: "Patients" }, { label: "System Error" }]}
    >
      <div className="flex items-center justify-center min-h-[450px] p-6 text-center">
        <div className="max-w-md bg-white rounded-2xl border border-red-100 p-8 shadow-sm flex flex-col items-center">
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-6">
            We encountered a temporary issue while retrieving the patient directory. All clinical records and sensitive data remain perfectly safe and encrypted. Please try refreshing the workspace component below.
          </p>
