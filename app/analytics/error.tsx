...
export default function AnalyticsErrorBoundary({
  ...
  useEffect(() => {
    console.error("Caught Analytics Route Error:", error);
  }, [error]);
  ...
  return (
    <AppLayout
      ...
      breadcrumbs={[{ label: "Dashboard" }, { label: "Analytics" }, { label: "System Error" }]}
    >
      <div className="flex items-center justify-center min-h-[450px] p-6 text-center">
        <div className="max-w-md bg-white rounded-2xl border border-red-100 p-8 shadow-sm flex flex-col items-center">
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-6">
            We encountered a temporary issue while compiling the data visualization blocks. All underlying telemetry databases remain unaffected. Please try parsing the workspace again.
          </p>
