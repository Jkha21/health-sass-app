...
export default function LabResultsErrorBoundary({
  error,
  reset,
  ...
  useEffect(() => {
    console.error("Caught Lab Results Route Error:", error);
  }, [error]);
  ...
  return (
    <AppLayout
      ...
      breadcrumbs={[{ label: "Dashboard" }, { label: "Lab Results" }, { label: "System Error" }]}
    >
      <div className="flex items-center justify-center min-h-[450px] p-6 text-center">
        <div className="max-w-md bg-white rounded-2xl border border-red-100 p-8 shadow-sm flex flex-col items-center">
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-6">
            We encountered a temporary issue while loading the laboratory reports interface. All clinical diagnostic records and patient data remain perfectly secure. Please try refreshing the workspace component below.
          </p>
